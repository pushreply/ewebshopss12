...
function validate(sender, myarray, err_hd) {
	...
	for (i = 0; i < myarray.length; i++) {
		...
		/*
		 * überprüft Felder, die als Preis formatiert sein müssen, ändert die
		 * Formatierung eventuell
		 */
			...
			/*
			 * im Fehlerfall werden hier die gesammelten Fehlermeldungen
			 * verarbeitet und angezeigt. Wenn das Formular ohne Beanstandung
			 * ist, wird es übertragen
			 */
			if (error) {
