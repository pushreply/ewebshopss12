...
public class ShopLogger {
    ...
    private static Logger getBaseLogger() {
        return Logger.getLogger("com.sun.javaee.blueprints.petstore", "com.sun.javaee.blueprints.petstore.util.LogStrings");
    }
    
    private static PropertyResourceBundle getBaseBundle() {
        try {
            return new PropertyResourceBundle(ShopLogger.class.getResourceAsStream("MessageStrings.properties"));
